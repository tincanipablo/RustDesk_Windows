...
#[no_mangle]
pub extern "C" fn wire_session_refresh(port_: i64, session_id: *mut wire_uint_8_list) {
    wire_session_refresh_impl(port_, session_id)
}
...
pub extern "C" fn wire_session_record_screen(
    ...
    wire_session_record_screen_impl(port_, session_id, start, width, height)
}

#[no_mangle]
pub extern "C" fn wire_session_record_status(
    port_: i64,
    session_id: *mut wire_uint_8_list,
    status: bool,
) {
    wire_session_record_status_impl(port_, session_id, status)
}
...
#[no_mangle]
pub extern "C" fn wire_session_get_flutter_option_by_peer_id(
    port_: i64,
    id: *mut wire_uint_8_list,
    k: *mut wire_uint_8_list,
) {
    wire_session_get_flutter_option_by_peer_id_impl(port_, id, k)
}
...
#[no_mangle]
pub extern "C" fn wire_session_get_reverse_mouse_wheel(
    port_: i64,
    session_id: *mut wire_uint_8_list,
) {
    wire_session_get_reverse_mouse_wheel_impl(port_, session_id)
}
...
pub extern "C" fn wire_session_switch_display(
    ...
    wire_session_switch_display_impl(port_, session_id, value)
}
...
pub extern "C" fn wire_session_read_dir_recursive(
    ...
    wire_session_read_dir_recursive_impl(port_, session_id, act_id, path, is_remote, show_hidden)
}
...
pub extern "C" fn wire_session_set_size(
    ...
    wire_session_set_size_impl(port_, _session_id, _width, _height)
}
...
#[no_mangle]
pub extern "C" fn wire_main_get_default_sound_input(port_: i64) {
    wire_main_get_default_sound_input_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_main_load_recent_peers_sync() -> support::WireSyncReturn {
    wire_main_load_recent_peers_sync_impl()
}
...
#[no_mangle]
pub extern "C" fn wire_main_get_current_display() -> support::WireSyncReturn {
    wire_main_get_current_display_impl()
}
...
pub extern "C" fn wire_session_get_rgba_size(
    ...
    wire_session_get_rgba_size_impl(session_id)
}
...
pub extern "C" fn wire_session_next_rgba(
    ...
    wire_session_next_rgba_impl(session_id)
}

#[no_mangle]
pub extern "C" fn wire_session_register_texture(
    session_id: *mut wire_uint_8_list,
    ptr: usize,
) -> support::WireSyncReturn {
    wire_session_register_texture_impl(session_id, ptr)
}
...
#[no_mangle]
pub extern "C" fn wire_main_start_pa(port_: i64) {
    wire_main_start_pa_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_main_hide_docker() -> support::WireSyncReturn {
    wire_main_hide_docker_impl()
}

#[no_mangle]
pub extern "C" fn wire_main_use_texture_render() -> support::WireSyncReturn {
    wire_main_use_texture_render_impl()
}
